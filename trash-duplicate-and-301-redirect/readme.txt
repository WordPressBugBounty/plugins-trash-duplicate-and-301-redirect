...
<a rel="nofollow" href="https://1.envato.market/EjDE2">https://codecanyon.net/item/trash-duplicate-and-301-redirect-pro-for-wordpress/20885697</a>
...
* Updated: Make compatible with WordPress 6.5.5
...
* Updated: Make compatible with PHP 8.x
...
* Fixed: Different Post Author then not display duplicate post list
* Fixed: Redirection not add when oldest/newest apply
* Fixed: Security issues
* Fixed: minor bug fix
